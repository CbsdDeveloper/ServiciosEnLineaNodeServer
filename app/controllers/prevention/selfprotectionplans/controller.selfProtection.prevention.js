...
const preventionModel = db.prevention.selfProtectionPrevention;

// ENCONTRAR REGISTRO POR ID
exports.findSelfProtectionPreventionByPlan = (req, res) => {
	// MODELO DE RETORNO
	let resources = {};
	let model = {};
	// CONSULTAR REGISTROS
	resourceModel.findAll({
		where: { recurso_clasificacion_prevencion: ['PREVENCIÓN Y CONTROL DE RIESGOS'] },
		order: [
            ['recurso_id']
        ]
	}).then(resourcesList => {
